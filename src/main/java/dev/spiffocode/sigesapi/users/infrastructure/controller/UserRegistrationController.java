...
public class UserRegistrationController {
    ...
    public ResponseEntity<@NonNull StudentResponse> registerAdmin(@RequestBody @Valid StudentRegistrationRequest request){
    ...
    public ResponseEntity<@NonNull InstitutionalStaffResponse> registerAdmin(@RequestBody @Valid InstitutionalStaffRegistrationRequest request){
