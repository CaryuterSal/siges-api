...
public class UserManagementController {
    ...
    public Page<@NonNull UserResponse> searchUsers(
            ...
            @Schema(description = "Query for searching by email, name, phone number, student registration number or employee number ")
            String searchQuery,
            ...
            @RequestParam(required = false)
             @Schema(description = "Filter by the type of user (admin, student or staff). Can select multiple of them")
