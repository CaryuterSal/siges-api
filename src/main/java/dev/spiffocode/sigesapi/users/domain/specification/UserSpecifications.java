...
public class UserSpecifications {
    ...
    public static Specification<@NonNull User> searchQuery(String query) {
        ...
        return (root, cq, cb) -> {
            ...
            return cb.or(
                    ...
                    cb.like(cb.lower(cb.treat(root, Student.class).get("registrationNumber")), pattern),
                    cb.like(cb.lower(cb.treat(root, InstitutionalStaff.class).get("employeeNumber")), pattern));
        };
    }
    ...
    public static Specification<@NonNull User> byShowMode(ShowModeFilter showMode) {
        if (showMode == null || showMode == ShowModeFilter.ALL)
            return (r, q, cb) -> null;
