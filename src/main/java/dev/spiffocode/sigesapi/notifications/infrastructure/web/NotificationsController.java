...
public class NotificationsController {
    ...
    public List<NotificationResponse> listNotifications(
            @SortDefault(sort = "sentAt")
            @ParameterObject
            @Schema(description = "Paging and ordering info")
            Pageable pageable,
            @RequestParam(required = false)
            @Schema(description = "Filter by notifications read and unread")
            ReadStatus status,
            @RequestParam(required = false)
            @Schema(description = "Filter by type of notification (semantic purpose)")
            Type type){
    ...
    public NotificationResponse changeNotificationStatus(@PathVariable Long id, @RequestBody @Valid NotificationStatusChangeRequest request){
    ...
    public ResponseEntity<@NonNull Void> changeAllNotificationsStatus( @RequestBody @Valid NotificationStatusChangeRequest request){
