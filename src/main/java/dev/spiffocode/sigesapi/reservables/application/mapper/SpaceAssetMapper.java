...
public interface SpaceAssetMapper {
    ...
    @Mapping(target = "inventoryNum", source = "inventoryItem.inventoryNum")
    @Mapping(target = "createdBy", ignore = true) // Handled by separate logic or mapper if needed
    SpaceAssetDto toDto(SpaceAsset asset);
