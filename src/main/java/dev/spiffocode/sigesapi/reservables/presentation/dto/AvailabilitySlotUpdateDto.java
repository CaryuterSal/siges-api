...
public record AvailabilitySlotUpdateDto(
                ...
                @Schema(description = "Availability end time") @NotNull LocalTime endTime,

                @Schema(description = "Days of the week this availability statement is valid") @ArraySchema(uniqueItems = true, minItems = 1, maxItems = 7) @NotEmpty Set<DayOfWeek> daysOfWeek) {
