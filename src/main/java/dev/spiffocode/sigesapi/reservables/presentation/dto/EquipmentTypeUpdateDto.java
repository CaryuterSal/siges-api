...
public record EquipmentTypeUpdateDto(
        ...
        @Schema(description = "Short description with details about the type of equipment", example = "Equipo de proyección visual para presentaciones") @Size(max = 400) @NotBlank String description) {
}
